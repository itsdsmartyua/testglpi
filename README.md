...
Telegram notifications mode for GLPI 11.0.4+ using standard Notifications.
...
- Enable "Telegram" mode (core flag `notifications_telegrambot`)
- Configure token + mapping in Telegram (telegrambot) settings page
